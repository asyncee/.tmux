...
```
$ cd
$ git clone https://github.com/asyncee/.tmux.git
...
```
$ git clone https://github.com/asyncee/.tmux.git /path/to/oh-my-tmux
...
[my own Vim configuration]: https://github.com/asyncee/.vim.git
